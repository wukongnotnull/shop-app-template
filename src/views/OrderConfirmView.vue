<template>
  <el-container>
    ...
    <el-main>
      ...
      <el-row>
        <el-col :span="6">
          <div class="grid-content bg-purple">收货地址1</div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple-light">收货地址2</div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple">收货地址3</div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple-light">收货地址4</div>
        </el-col>
      </el-row>
      <!--      标题 2-->
      ...
      <el-row style="text-align: right">
        <router-link to="/cashiermain"><el-button type="danger" size="medium">提交订单</el-button></router-link>
      </el-row>
    </el-main>
